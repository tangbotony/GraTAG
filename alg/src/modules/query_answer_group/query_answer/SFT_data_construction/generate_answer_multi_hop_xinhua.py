...
my_mongo_db_data_answer = db.open_domain_qa_multi_hop_xinhua_0513
...
def query_sft_get_explanation(content: dict):
    ...
    try:
        ...
        log.warning("question: {}".format(content['question']))
        log.warning(e)
...
if __name__ == '__main__':
    ...
    # 添加命令行参数
    parser.add_argument("--num-queries", default=2000, help="")
    ...
    with open("/Users/carol/Documents/code/JournalistAssistant/include/SFT/labelstudio/question-2-answer/answer_generate/data/question-2-answer-all.json", 'r', encoding='utf-8') as file:
        # 使用json.load()方法读取并解析文件内容
        data = json.load(file)
