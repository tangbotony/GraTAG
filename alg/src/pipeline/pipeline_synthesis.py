...
if __name__ == '__main__':
    ...
    data = []
    with open("/Users/xxx/code/GraTAG/data/qa/iaar_150.txt", 'r', encoding='utf-8') as file:
        for line in file:
    ...
    res_write_output_func(
        ...
        "/Users/xxx/code/GraTAG/data/result/AINews_answer_{}.json".format(args.exp_name))
